    ...
    <div class="grid-2">
        ...
        <div class="card">
            ...
            <form action="{{ route('settings.update') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex align-center gap-2">
                        <input type="time" name="office_start_time" class="form-control" 
                            value="{{ $settings['office_start_time']->value ?? '08:00' }}">
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex align-center gap-2">
                        <input type="time" name="late_tolerance_time" class="form-control" 
                            value="{{ $settings['late_tolerance_time']->value ?? '08:15' }}">
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex align-center gap-2">
                        <input type="time" name="office_end_time" class="form-control" 
                            value="{{ $settings['office_end_time']->value ?? '17:00' }}">
                ...
                <div class="alert alert-info mt-4">
                    ...
                    <div>
                        <strong>Info:</strong> Perubahan jam kerja akan berpengaruh pada status kehadiran (Tepat Waktu/Terlambat) untuk presensi hari-hari berikutnya.
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div style="padding: 20px; background: var(--bg-tertiary); border-radius: var(--radius-md);">
                <div class="mb-6">
                    <div class="text-muted mb-2" style="font-size: 12px; text-transform: uppercase; letter-spacing: 1px;">Pagi Hari</div>
                    <div class="d-flex align-center gap-4">
                        <div>
                            <div class="text-success fw-bold">
                                <i class="fas fa-check-circle"></i> Tepat Waktu
                            </div>
                            <small class="text-muted">Sebelum {{ $settings['office_start_time']->value ?? '08:00' }}</small>
                        </div>
                        ...
                        <div>
                            ...
                            <small class="text-muted">Setelah {{ $settings['late_tolerance_time']->value ?? '08:15' }}</small>
                        </div>
                    </div>
                </div>

                <div>
                    <div class="text-muted mb-2" style="font-size: 12px; text-transform: uppercase; letter-spacing: 1px;">Sore Hari</div>
                    <div class="d-flex align-center gap-4">
                        <div>
                            <div class="text-success fw-bold">
                                <i class="fas fa-sign-out-alt"></i> Boleh Pulang
                            </div>
                            <small class="text-muted">Mulai {{ $settings['office_end_time']->value ?? '17:00' }}</small>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card mt-6">
        ...
        <form action="{{ route('settings.update') }}" method="POST">
            ...
            <div class="alert alert-info mt-4">
                ...
                <div>
                    <strong>Tips:</strong> Gunakan Google Maps untuk mendapatkan titik koordinat yang presisi. Klik kanan pada lokasi kantor di Google Maps dan pilih koordinat paling atas.
                </div>
            </div>
