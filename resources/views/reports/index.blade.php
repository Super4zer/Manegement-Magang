...
<div class="slide-up">
    <div class="d-flex justify-between align-center mb-6" style="flex-wrap: wrap; gap: 16px;">
        <div>
            <h2 style="margin-bottom: 4px;">Laporan Magang</h2>
            <p class="text-muted">Kelola laporan perkembangan siswa</p>
        </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $report->intern->user->name ?? 'N/A' }}</td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <form action="{{ route('reports.destroy', $report) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus laporan ini?')">
                                        @csrf
                                        @method('DELETE')
