...
<div class="slide-up">
    <div class="d-flex align-center gap-4 mb-6">
        ...
        <div style="flex: 1;">
            ...
            <p class="text-muted">{{ $report->intern->user->name }} | {{ $report->period_start->format('d M') }} - {{ $report->period_end->format('d M Y') }}</p>
        </div>
        ...
        <div>
            ...
            <div class="card" style="background: rgba(34, 197, 94, 0.1); border-color: rgba(34, 197, 94, 0.3);">
                <div class="card-header" style="border-color: rgba(34, 197, 94, 0.3);">
                    <h3 class="card-title" style="color: var(--success);"><i class="fas fa-comment-alt"></i> Feedback</h3>
                </div>
            ...
            <div class="card">
                ...
                <form action="{{ route('reports.feedback', $report) }}" method="POST">
                    ...
                    <div class="form-group">
                        <textarea name="feedback" class="form-control" rows="4" required placeholder="Tulis feedback untuk laporan ini..."></textarea>
                    </div>
