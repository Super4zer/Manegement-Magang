        ...
        <div class="d-flex align-center gap-4" style="flex-wrap: wrap;">
            ...
            <div style="flex: 1;">
                ...
                <div class="mt-4">
                    ...
                    @if($intern)
                        <span class="badge badge-{{ $intern->status === 'active' ? 'success' : 'secondary' }}" style="font-size: 14px; padding: 8px 16px; margin-left: 8px;">
    ...
    @if($intern)
        ...
        <div class="stat-grid">
            ...
            <div class="stat-card">
                ...
                <div class="progress mt-4">
                    <div class="progress-bar" style="width: {{ $stats['overallScore'] }}%; background: linear-gradient(90deg, #f59e0b, #d97706);"></div>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-6">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-chart-radar"></i> Radar Penilaian (Rata-rata dari 5 Penilaian Terakhir)</h3>
            </div>
            ...
            <div class="card">
                ...
                <div style="display: grid; gap: 16px;">
                    ...
                    <div>
                        ...
                        <div><strong>{{ $intern->start_date->format('d M Y') }} - {{ $intern->end_date->format('d M Y') }}</strong></div>
                    </div>
                    <div>
