        ...
        <form action="{{ route('tasks.update', $task) }}" method="POST">
            ...
            <div class="grid-2">
                ...
                <div class="form-group">
                    ...
                    <input type="time" name="deadline_time" class="form-control" value="{{ old('deadline_time', $task->deadline_time ?? '23:59') }}">
                </div>
            </div>
            ...
            <div class="grid-2">
                <div class="form-group">
                    ...
                    <input type="number" name="estimated_hours" class="form-control" value="{{ old('estimated_hours', $task->estimated_hours) }}" min="1">
                </div>
                <div class="form-group">
            ...
            <div class="card mt-4" style="background: var(--bg-tertiary);">
                ...
                <div>
                    ...
                    <div><a href="{{ Storage::url('submissions/' . $task->submission_file) }}" target="_blank">{{ $task->submission_file }}</a></div>
                </div>
                @endif
            </div>
            @endif
